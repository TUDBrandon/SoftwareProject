...
$price = '50';
$description = 'Give the gift of gaming with a Steam Gift Card. This digital gift card can be redeemed on Steam for games, software, hardware, and more. Perfect for gamers who want to choose their own adventure from Steam\'s vast library of titles.';
$image_path = 'images/gitcardSteam.jpeg';
$image_alt = 'Steam Gift Card';
